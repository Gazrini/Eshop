<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoriesProductDetails.ascx.cs" Inherits="EShop.UserControls.CategoriesProductDetails" %>
...
<asp:DataList ID="DataList1" runat="server" DataKeyField="prod_id" DataSourceID="SqlDataSource1">
    <ItemTemplate>
        ...
        <br />
        <div align="center">
            <asp:Button ID="ButtonBack" runat="server" Text="Back" PostBackUrl='<%# "~/CategoriesListDisplay.aspx?cat_id=" + Eval("cat_id") %>' />
            <br />
            <br />
        </div>
    </ItemTemplate>
