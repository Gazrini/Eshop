<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchPage.ascx.cs" Inherits="EShop.UserControls.SearchPage" %>
        ...
        <td runat="server" style="column-width: 140px" align="center">
            <p>
                <asp:HyperLink ID="HyperLink1" Text='<%# Eval("prod_title") %>'
                    runat="server" NavigateUrl='<%# "~/ProductDetails.aspx?prod_id=" + Eval("prod_id") %>'></asp:HyperLink>
            </p>
