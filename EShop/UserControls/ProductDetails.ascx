<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductDetails.ascx.cs" Inherits="EShop.UserControls.ProductDetails" %>
...
<asp:DataList ID="DataList1" runat="server" DataKeyField="prod_id" DataSourceID="SqlDataSource1">
    <ItemTemplate>
        ...
        <br />
        <div align="center">
            <asp:Button ID="ButtonBuy" runat="server" Text="Buy" PostBackUrl="~/GuestProducts.aspx" />
            <br />
            <br />
        </div>
    </ItemTemplate>
