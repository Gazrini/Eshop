<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WishListCheckout.ascx.cs" Inherits="EShop.UserControls.WishListCheckout" %>
...
<form>
    ...
    <div align="center">
        ...
        <asp:Label ID="LabelEwallet" runat="server"></asp:Label>&nbsp;and your balance is RM
            <asp:Label ID="LabelBalance" runat="server"></asp:Label></b>
    </div>
    <br />
    <div align="center">
