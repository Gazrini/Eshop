...
{
    public partial class AddWishlist : System.Web.UI.UserControl
    {
        ...
        protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            Response.Redirect("ViewWishlist.aspx?id=" + e.CommandArgument.ToString() + "&quantity=" + dlist.SelectedItem.ToString());
        }
