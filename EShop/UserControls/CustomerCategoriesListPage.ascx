<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomerCategoriesListPage.ascx.cs" Inherits="EShop.UserControls.CustomerCategoriesListPage" %>
        ...
        <td runat="server" style="column-width: 140px" align="center">
            <p>
                <asp:HyperLink ID="HyperLink1" Text='<%# Eval("prod_title") %>'
                    runat="server" NavigateUrl='<%# "~/CustomerCategoriesProductDetailsDisplay.aspx?prod_id=" + Eval("prod_id") %>'></asp:HyperLink>
            </p>
