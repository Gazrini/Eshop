<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomerProducts.ascx.cs" Inherits="EShop.UserControls.CustomerProducts" %>
...
<br />
<div align="center">
    <asp:HyperLink ID="ShowCartLink" runat="server" NavigateUrl="~/AddToCart.aspx">View Cart</asp:HyperLink>
</div>
<br />
<div align="center">
    ...
    <asp:DataList ID="DataList1" runat="server" DataKeyField="prod_id" RepeatDirection="Horizontal" RepeatColumns="3" OnItemCommand="DataList1_ItemCommand">
        <ItemTemplate>
            <table>
                ...
                <tr>
                    <td align="center">
                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/viewdetails.png" Width="100px" PostBackUrl='<%# "~/CustomerProductDetails.aspx?prod_id=" + Eval("prod_id") %>' Text='<%# Eval("prod_title") %>' />
                    </td>
                </tr>
            </table>
            <br />
