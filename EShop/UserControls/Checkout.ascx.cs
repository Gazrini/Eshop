...
namespace EShop.UserControls
{
    public partial class Checkout : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //payumoney coding
            LabelPayU.Text = grandtotal().ToString() + ".00";
        ...
        protected void Button2_Click(object sender, EventArgs e) //payumoney coding
        {
            DataTable dt;
            dt = (DataTable)Session["buyitems"];
        ...
        protected void Button3_Click(object sender, EventArgs e) //paypal coding account 
        {
            DataTable dt;
            dt = (DataTable)Session["buyitems"];
            ...
            saveaddress();
            Response.Redirect("https://www.sandbox.paypal.com/cgi-bin/webscr?cmd=_xclick&business=sb-ppzei960484@business.example.com&amount=" + totalAmount + "&return=http://localhost:57138/CustomerHomepage.aspx" + (Session["BuyItems"] = null));
        }
